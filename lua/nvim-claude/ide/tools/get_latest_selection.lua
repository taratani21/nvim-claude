-- v1: delegates to the same logic as getCurrentSelection.
-- A separate "remembered last selection" buffer is not tracked across mode changes yet.
local M = {
  name = "getLatestSelection",
  description = "Return the most recent visual selection (v1: same as getCurrentSelection).",
